                    ...
                    style={{
                      backgroundColor:
                        hoveredRow === index
                          ...
                          : "rgb(71, 71, 71)",
                      transform:
                        hoveredRow === index ? "scale(1.02)" : "scale(1)",
                    }}
        ...
        >
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-sm text-gray-300">
              Veja a diferença entre OCRM e outros sistemas
            </p>
          </div>
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  {/* OCRM */}
                  <div className="flex flex-col items-center gap-1">
                    <span className="text-xs text-yellow-bright font-semibold">
                      OCRM
                    </span>
                    {feature.ocrm ? (
          ...
          >
            <div className="text-center">
              ...
              <p className="text-xs text-gray-300">
                {features.filter((f) => f.ocrm && !f.otherCRMs).length}{" "}
                funcionalidades exclusivas que outros CRMs não oferecem
              </p>
            </div>
          </motion.div>
        </motion.div>
