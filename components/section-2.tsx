...
export function Section2() {
  ...
  return (
    <section ref={sectionRef} className="spacing-responsive relative overflow-hidden" style={{ backgroundColor: '#161616' }}>
      {/* Fundo limpo */}
      ...
      <div className="container-responsive relative z-10">
        <div className="text-center mb-6 sm:mb-8 md:mb-12 lg:mb-16">
                  ...
                  >
                    ...
                    <span style={{ color: 'rgb(255, 234, 0)' }} className="font-semibold"> Sabedoria digital</span> para decisões fundamentadas.
                  </motion.h2>
                  ...
                  <motion.p 
                    ...
                    viewport={{ once: true }}
                  >
                    <span style={{ color: 'rgb(255, 234, 0)' }} className="font-semibold">Visão integral</span> da jornada do cliente. 
                    <span style={{ color: 'rgb(255, 234, 0)' }} className="font-semibold"> Indicadores em tempo real</span> que transformam dados em vantagem competitiva.
                  </motion.p>
        </div>
        ...
        >
                  <p className="text-responsive-base text-gray-300 mb-3 sm:mb-4 md:mb-6">
                    Dados isolados não dizem nada. Conectados com sabedoria, <span style={{ color: 'rgb(255, 234, 0)' }} className="font-semibold">dizem tudo</span>.
                  </p>
                  <button 
                  ...
                  >
                    <span className="hidden sm:inline">Fale conosco e garanta tudo isso</span>
