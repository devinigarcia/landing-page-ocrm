        ...
        >
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 max-w-6xl">
            <div className="flex items-center gap-2 sm:gap-3 group">
              <div
                className="w-3 h-3 sm:w-4 sm:h-4 rounded-full shadow-lg group-hover:shadow-xl transition-all duration-300"
                style={{
                  background:
                    "linear-gradient(to bottom right, rgb(255, 234, 0), rgb(229, 186, 0))",
                }}
              ></div>
              <span className="text-gray-300 font-medium group-hover:text-white transition-colors duration-300 text-xs sm:text-sm">
                Gestão Comercial
              </span>
            </div>
            <div className="flex items-center gap-2 sm:gap-3 group">
        ...
        >
          <div className="bg-gradient-to-r from-gray-dark/50 via-gray-medium/30 to-gray-dark/50 rounded-3xl p-6 sm:p-8 md:p-12 border border-yellow-bright/20 shadow-xl backdrop-blur-sm">
            ...
            <p className="text-responsive-base text-gray-300 mb-6 sm:mb-8 max-w-2xl mx-auto">
              Descubra como o OCRM pode revolucionar a forma como você gerencia
